...
export function ReportPresetCard({
  ...
  return (
    <Card className="hover:border-black/50 transition-all duration-200">
      {" "}
      <div className="p-6">
        {" "}
        <div className="flex items-start justify-between mb-4">
          ...
          <div className="flex items-center gap-3">
            {" "}
            <div
              className={`p-2 rounded-none bg-${preset.color}-500/10`}
            >
              {" "}
            ...
            <div>
              {" "}
              <SubsectionHeader className="font-semibold text-white">{preset.name}</SubsectionHeader>{" "}
              <BodyText>{preset.subcategory}</BodyText>{" "}
            </div>{" "}
          </div>{" "}
          <Button
            variant="ghost"
          ...
          >
            {" "}
            <Star
              className={`w-5 h-5 ${isFavorite ? "fill-yellow-500 text-warning" : " "}`}
            />{" "}
          </Button>{" "}
        </div>{" "}
        <BodyText className="mb-4 line-clamp-2"> {preset.description} </BodyText>{" "}
        <div className="flex items-center justify-between">
          {" "}
          <div className="flex gap-2">
            {" "}
            <Badge> {preset.category} </Badge>{" "}
            <Badge> {preset.display_format} </Badge>{" "}
          </div>{" "}
