...
export default function ReferralDashboardPage() {
  ...
  const rewardTiers = [
    ...
    { name: 'Silver', min: 10, max: 19, reward: '$30/referral', color: 'text-gray-400' },
    ...
    <CompvssLayout breadcrumbs={breadcrumbs}>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          >
            <Card variant="compvss" className="bg-gray-900/50 backdrop-blur-sm mb-6">
              <CardHeader>
                <div className="flex items-center justify-between">
                  ...
                  {rewardTiers.map((tier) => (
                    <div
                      ...
                      className={`p-4 rounded-lg ${
                        tier.active 
                          ? 'bg-compvss-cyan-500/10 border-2 border-compvss-cyan-500' 
                  ...
                  {leaderboard.map((entry: LeaderboardEntry & { isCurrentUser?: boolean }) => (
                    <div
                      ...
                      className={`p-4 rounded-lg ${
                        entry.isCurrentUser
                          ? 'bg-compvss-cyan-500/10 border-2 border-compvss-cyan-500'
                          : 'bg-black/50 border border-compvss-cyan-500/20'
                      }`}
                    >
                      <div className="flex items-center gap-4">
                        ...
                        <div className="flex-1">
                          <h3 className="font-oswald text-white">
                            {entry.name}
