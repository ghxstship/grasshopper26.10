...
// This component calls: /Users/julianclarkson/Documents/Grasshopper26.10/api/compvss/applications
        ...
        <Card className="mb-6">
          <div className="p-6">
            <div className="flex items-center gap-4">
              <label className="text-body-sm text-grey-700">Filter by Status:</label>
              <Select
                value={statusFilter}
        ...
        {error && (
          <Card className="border-error">
            <div className="p-6 text-center">
              ...
              <BodyText className="text-error mb-4">Failed to load applications</BodyText>
