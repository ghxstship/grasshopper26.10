...
export default function CredentialVaultPage() {
  ...
  const getStatusBadge = (status: string) => {
    switch (status) {
      case 'verified':
        return <Badge variant="compvss" className="bg-success-light text-success border-green-500/30">Verified</Badge>;
      case 'expiring':
        return <Badge variant="compvss-outline" className="border-yellow-500/30 text-warning">Expiring Soon</Badge>;
      case 'pending':
      ...
      <div className="border-b border-gray-800 bg-gradient-to-r from-black via-gray-950 to-black">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bebas compvss-text-gradient">Credential Vault</h1>
              <p className="text-gray-400 font-oswald mt-1">Manage your certifications and credentials</p>
            </div>
            <Link href="/compvss/credentials/upload">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                {credentials.map((cred: Credential, index: number) => (
                  ...
                  >
                    ...
                    <div className="flex items-center justify-between pt-3 border-t border-gray-800">
                      <span className="text-xs text-gray-500 font-share-tech">
                        ID: {cred.id}
                      </span>
        ...
        >
          <Card variant="compvss" className="bg-gray-900/30 border-compvss-cyan-500/20">
            <CardContent className="pt-6">
              <h3 className="text-lg font-bebas text-white mb-3">Credential Requirements</h3>
