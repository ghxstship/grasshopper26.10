          ...
          <div className="flex items-center justify-between">
            <div>
              <div className="flex items-center gap-3 mb-2">
                <h1 className="text-3xl font-bebas compvss-text-gradient">Day-of-Show Dashboard</h1>
                <Badge variant="compvss" className="bg-success-light text-success border-green-500/30 animate-pulse">
            ...
            <div className="text-right">
              <div className="text-2xl font-bebas text-white">{eventInfo.currentTime}</div>
              <div className="text-xs text-gray-400 font-share-tech">Event Time</div>
            </div>
          </div>
        </div>
      </div>
            ...
            <CardContent className="pt-6">
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-xs text-gray-400 font-share-tech">Date</p>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-xs text-gray-400 font-share-tech">Venue</p>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-xs text-gray-400 font-share-tech">Start Time</p>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-xs text-gray-400 font-share-tech">Status</p>
                ...
                <CardContent className="pt-6">
                  <div className="flex items-center justify-between mb-2">
                    <div className={`p-2 rounded-lg ${
                      metric.status === 'good' ? 'bg-green-500/10 text-success' : 'bg-warning/10 text-warning'
                    }`}>
                      {metric.icon}
                    </div>
                    <div className={`w-2 h-2 rounded-full ${
                      metric.status === 'good' ? 'bg-green-500' : 'bg-warning'
                    } animate-pulse`} />
                  </div>
                    ...
                    >
                      <div className="flex items-start justify-between mb-2">
                        <div className="flex-1">
                          ...
                          <p className="text-sm text-gray-400 font-share-tech">{task.zone}</p>
                        </div>
                        <Badge 
                          variant={task.status === 'completed' ? 'compvss' : 'compvss-outline'}
                          className={
                            task.status === 'completed' ? 'bg-success-light text-success border-green-500/30' :
                            task.status === 'in_progress' ? 'bg-info-light text-info border-blue-500/30' :
                      ...
                      <p className="text-xs text-gray-500 font-share-tech">Scheduled: {task.time}</p>
                    </div>
                  ))}
                </div>
              </CardContent>
                ...
                <div className="space-y-3">
                  {upcomingSchedule.map((item, index) => (
                    ...
                    >
                      <div className="flex items-center justify-between">
                        <div>
                          <div className="text-2xl font-bebas text-compvss-cyan-500 mb-1">
                            {item.time}
                          </div>
