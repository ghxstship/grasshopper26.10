          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
            <Card variant="compvss" className="bg-gray-900/80 backdrop-blur-sm border-2 border-compvss-cyan-500/20">
              <CardContent className="pt-6">
                <div className="flex items-center justify-between mb-2">
                  <p className="text-sm text-gray-400 font-oswald">Total Requests</p>
                  <BarChart3 className="w-5 h-5 text-compvss-cyan-500" />
                </div>
                <p className="text-4xl font-bebas text-white mb-1">{stats.totalRequests}</p>
            ...
            <Card variant="compvss" className="bg-green-500/10 border-green-500/30">
              <CardContent className="pt-6">
                ...
                <p className="text-4xl font-bebas text-success mb-1">{stats.approved}</p>
                <p className="text-xs text-gray-400 font-share-tech">
            ...
            <Card variant="compvss" className="bg-warning/10 border-yellow-500/30">
              <CardContent className="pt-6">
                ...
                <p className="text-4xl font-bebas text-warning mb-1">{stats.pending}</p>
                <p className="text-xs text-gray-400 font-share-tech">
            ...
            <Card variant="compvss" className="bg-error/10 border-red-500/30">
              <CardContent className="pt-6">
                ...
                <p className="text-4xl font-bebas text-error mb-1">{stats.rejected}</p>
                <p className="text-xs text-gray-400 font-share-tech">
            ...
            <Card variant="compvss" className="bg-compvss-cyan-500/10 border-compvss-cyan-500/30">
              <CardContent className="pt-6">
                <div className="flex items-center justify-between mb-2">
                  <p className="text-sm text-gray-400 font-oswald">Completion Rate</p>
                  <AlertTriangle className="w-5 h-5 text-compvss-cyan-500" />
                </div>
                <p className="text-4xl font-bebas text-compvss-cyan-500 mb-1">{stats.completionRate}%</p>
                <p className="text-xs text-gray-400 font-share-tech">
            ...
            <Card variant="compvss" className="bg-gray-900/80 backdrop-blur-sm border-2 border-compvss-cyan-500/20">
              <CardContent className="pt-6">
                <div className="flex items-center justify-between mb-2">
                  <p className="text-sm text-gray-400 font-oswald">Avg Response Time</p>
                  <Clock className="w-5 h-5 text-compvss-cyan-500" />
                </div>
                <p className="text-4xl font-bebas text-white mb-1">{stats.avgResponseTime}</p>
                <div className="flex items-center gap-2 text-xs text-success font-share-tech">
                  <TrendingUp className="w-3 h-3" />
                  <span>15% faster</span>
                </div>
              ...
              <div className="space-y-4">
                {categoryBreakdown.map((cat) => (
                  <div key={cat.category}>
                    <div className="flex items-center justify-between mb-2">
                      <span className="text-sm font-oswald text-white">{cat.category}</span>
                      <span className="text-sm font-bebas text-gray-400">{cat.count} total</span>
                    </div>
                    ...
                    <div className="flex gap-4 mt-1 text-xs font-share-tech">
                ...
                {recentActivity.map((day) => (
                  <div key={day.date} className="flex items-center justify-between p-3 bg-black/50 rounded-lg">
                    <div className="flex items-center gap-4">
                      <span className="text-sm font-oswald text-gray-300">
                        {new Date(day.date).toLocaleDateString('en-US', { month: 'short', day: 'numeric' })}
                      </span>
                      <Badge variant="default">{day.requests} requests</Badge>
                    </div>
                    <div className="flex gap-3 text-xs font-share-tech">
