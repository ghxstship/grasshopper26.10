...
import { Plane, Save, AlertCircle } from 'lucide-react';
  ...
  return (
    <CompvssLayout>
      <ContentLayout
        ...
        description="Travel and flight arrangements"
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <FormField label="Origin" required>
                    <Input type="text" placeholder="Departure city/airport" className="bg-black/50 border-compvss-cyan-500/30" variant="compvss" required />
                  </FormField>
                  <FormField label="Destination" required>
                    <Input type="text" placeholder="Arrival city/airport" className="bg-black/50 border-compvss-cyan-500/30" variant="compvss" required />
                  </FormField>
                </div>

                <FormField label="Number of Travelers" required>
                  <Input type="number" placeholder="Number of people traveling" className="bg-black/50 border-compvss-cyan-500/30" variant="compvss" required />
                </FormField>

                <FormField label="Detailed Requirements" required>
                  <Textarea placeholder="Specific travel needs, class preferences, baggage requirements, special accommodations..." className="bg-black/50 border-compvss-cyan-500/30" variant="compvss" required />
                </FormField>

                <FormField label="Budget Estimate">
                  <Input type="text" placeholder="e.g., $5,000" className="bg-black/50 border-compvss-cyan-500/30" variant="compvss" />
                </FormField>
