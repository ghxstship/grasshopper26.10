...
import { Construction, Save, AlertCircle } from 'lucide-react';
...
// This component calls: /Users/julianclarkson/Documents/Grasshopper26.10/api/compvss/advancing/heavy-equipment

export default function HeavyEquipmentAdvancingPage() {
          ...
          <Card variant="compvss" className="bg-grey-900/50">
            <CardHeader>
              <CardTitle className="text-white flex items-center gap-2">
                <Construction className="w-5 h-5 text-compvss-cyan-500" />
                Heavy Equipment Details
              </CardTitle>
              <CardDescription className="text-grey-400">
                Standard advancing request form - Heavy Equipment category
              </CardDescription>
            </CardHeader>
            <CardContent>
              {errors.submit && (
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <FormField label="Equipment Type" required>
                  <Select className="bg-black/50 border-compvss-cyan-500/30" variant="compvss">
                    ...
                    <option value="lift">Scissor/Boom Lifts</option>
                ...
                <FormField label="Detailed Requirements" required>
                  <Textarea placeholder="Specific equipment needs, operator requirements, safety certifications..." className="bg-black/50 border-compvss-cyan-500/30" variant="compvss" required />
                </FormField>
