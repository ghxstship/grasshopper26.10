...
import { CompvssService } from '@/lib/services/compvss/advancing/security.service';
  ...
  try {
    ...
    const advancingRequest = await new CompvssService().create({
      data: {
        ...
        title: validatedData.title || 'Security Request',
        description: validatedData.description,
        status: 'PENDING',
        priority: validatedData.priority || 'HIGH',
