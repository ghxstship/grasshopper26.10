      ...
      <GvtewayLayout>
        <div className="flex items-center justify-center min-h-[60vh]">
          <div className="text-center">
            ...
            <BodyText className="text-grey-400">Loading profile...</BodyText>
          </div>
        </div>
      </GvtewayLayout>
    );
      ...
      <GvtewayLayout>
        <div className="flex items-center justify-center min-h-[60vh]">
          <div className="text-center">
            ...
            <SectionHeader className="mb-2">Failed to Load Profile</SectionHeader>
            <BodyText className="text-grey-400">Unable to load your profile settings</BodyText>
          </div>
        </div>
      </GvtewayLayout>
    );
    ...
    <GvtewayLayout>
      <div className="min-h-screen bg-gradient-to-br from-black via-grey-900 to-black p-6">
        <div className="max-w-4xl mx-auto space-y-6">
          <div>
            <HeroTitle className="text-white mb-2">Profile Settings</HeroTitle>
            <BodyText className="text-grey-400">Customize your public profile</BodyText>
          </div>

          <Card variant="gvteway" className="bg-grey-900/50 border-grey-800">
            <CardHeader>
              <CardTitle className="text-white">Profile Photo</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="flex items-center gap-6">
                <div className="relative w-24 h-24 rounded-full bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center text-white">
                  JD
                </div>
                ...
                <BodyText className="text-body-sm text-grey-400 mt-2">JPG, PNG or GIF. Max 5MB.</BodyText>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card variant="gvteway" className="bg-grey-900/50 border-grey-800">
          ...
          <CardContent>
            <Textarea
              ...
              className="bg-black/50 border-grey-700 text-white min-h-[120px]"
            />
          </CardContent>
        </Card>
          ...
          <CardContent className="space-y-4">
            <div>
              ...
              <Input
                ...
                className="bg-black/50 border-grey-700 text-white"
              />
            </div>
            <div>
              <div className="flex items-center gap-2 mb-2">
        ...
        <Card variant="gvteway" className="bg-grey-900/50 border-grey-800">
          ...
          <CardContent className="space-y-4">
            <div>
              <div className="flex items-center gap-2 mb-2">
                <Instagram className="w-4 h-4 text-grey-400" />
            ...
            <div>
              <div className="flex items-center gap-2 mb-2">
                <Twitter className="w-4 h-4 text-grey-400" />
