    ...
    return (
      <GvtewayLayout>
        <div className="flex flex-col items-center justify-center min-h-screen">
          ...
          <h2 className="text-h4 font-bebas text-white mb-2">Product Not Found</h2>
          ...
          <div className="max-w-7xl mx-auto">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
              <div className="grid lg:grid-cols-2 gap-12">
                ...
                <div>
                  <h1 className="text-h2 font-bebas text-white mb-4">{product.name}</h1>
                  <div className="flex items-center gap-2 mb-6">
                    <Star className="w-5 h-5 fill-yellow-500 text-warning" />
                    <span className="text-white">4.8</span>
                    <span className="text-gray-400">(156 reviews)</span>
                  </div>
                  <p className="text-h3 font-bebas text-gvteway-red-500 mb-6">${product.price}</p>
