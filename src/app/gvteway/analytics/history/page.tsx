    ...
    <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-black p-6">
      <div className="max-w-6xl mx-auto space-y-6">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-h2 text-white mb-2">Event History</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <Card className="bg-gradient-to-br from-blue-600/20 to-blue-800/20 border-info/30">
            <CardContent className="p-6">
              <p className="text-info text-body-sm">Total Events</p>
              <p className="text-h3 text-white mt-2">24</p>
            </CardContent>
          </Card>

          <Card className="bg-gradient-to-br from-purple-600/20 to-purple-800/20 border-accent/30">
            <CardContent className="p-6">
              <p className="text-atlvs-purple-500 text-body-sm">Total Tickets</p>
              <p className="text-h3 text-white mt-2">47</p>
            </CardContent>
          </Card>

          <Card className="bg-gradient-to-br from-green-600/20 to-green-800/20 border-success/30">
            <CardContent className="p-6">
              <p className="text-success text-body-sm">Total Spent</p>
              <p className="text-h3 text-white mt-2">$2,450</p>
            </CardContent>
          </Card>

          <Card className="bg-gradient-to-br from-orange-600/20 to-orange-800/20 border-warning/30">
            <CardContent className="p-6">
              <p className="text-atlvs-orange-500 text-body-sm">This Year</p>
              <p className="text-h3 text-white mt-2">12</p>
            </CardContent>
          </Card>
        </div>
                ...
                <CardContent className="p-6">
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      <h3 className="text-h5 text-white mb-3">{event.eventName}</h3>
                    ...
                    <div className="text-right">
                      <p className="text-h4 text-white mb-2">${event.amount}</p>
