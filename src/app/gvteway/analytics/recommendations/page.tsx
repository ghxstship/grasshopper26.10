      ...
      <GvtewayLayout>
        <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-black flex items-center justify-center">
          <div className="text-center">
            ...
            <h2 className="text-h5 font-bebas mb-2">Failed to Load Recommendations</h2>
  ...
  return (
    ...
    <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-black p-6">
      <div className="max-w-6xl mx-auto space-y-6">
        <div>
          <h1 className="text-h2 text-white mb-2 flex items-center gap-3">
          ...
          <CardContent className="p-6">
            <div className="flex items-center gap-4">
              ...
              <div className="flex-1">
                <h3 className="text-white text-h6">Your Taste Profile</h3>
          ...
          {recommendations.length === 0 ? (
            <Card className="bg-gray-900/50 border-gray-800">
              <CardContent className="p-12 text-center">
                ...
                <p className="text-body-sm text-gray-500 mt-2">Attend more events to get personalized recommendations</p>
              </CardContent>
            </Card>
          ) : (
            recommendations.map((event) => (
            <Card key={event.id} className="bg-gray-900/50 border-gray-800 hover:border-accent/50 transition-all">
              <CardContent className="p-6">
                <div className="flex gap-6">
                  ...
                  <div className="flex-1">
                    <div className="flex items-start justify-between mb-3">
                      <div>
                        <h3 className="text-h4 text-white mb-2">{(event as any).title || 'Recommended Event'}</h3>
                      ...
                      <Badge className="bg-gradient-to-r from-purple-500 to-blue-500 text-white border-0 text-h6 px-4 py-1">
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        <span className="text-gray-400 text-body-sm">From </span>
                        <span className="text-h4 text-white">${(event as any).price || 0}</span>
                      </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
              {['Music', 'Sports', 'Tech', 'Comedy', 'Arts', 'Food', 'Theater', 'Festivals'].map((category) => (
                <Button
                  key={category}
                  variant="outline"
                  className="border-gray-700 hover:bg-accent/20 hover:border-accent"
                >
                  {category}
                </Button>
              ))}
