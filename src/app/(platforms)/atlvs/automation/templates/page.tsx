  ...
  React.useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const response = await apiClient.get<any>('/api/atlvs/automation/templates');
        if (response.data) {
          setData(response.data.templates || response.data);
        }
      } catch (error) {
    ...
    <div className="container mx-auto p-6">
      ...
      <Card variant="atlvs" className="mt-6">
        ...
        <CardContent>
          ...
          <div className="mt-4">
            <Button variant="atlvs">Take Action</Button>
          </div>
        </CardContent>
      </Card>
    </div>
