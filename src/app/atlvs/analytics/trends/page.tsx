      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6" role="region" aria-label="Trend statistics">
          <Card variant="atlvs" className="bg-gray-900/50">
            <CardHeader>
              <div className="text-sm text-gray-400 mb-1">Project Growth</div>
              <div className="text-3xl font-bebas atlvs-text-gradient" aria-label="Project growth up 18 percent versus last month">+18%</div>
          ...
          <Card variant="atlvs" className="bg-gray-900/50">
            <CardHeader>
              <div className="text-sm text-gray-400 mb-1">Team Efficiency</div>
              <div className="text-3xl font-bebas text-atlvs-green-500" aria-label="Team efficiency up 12 percent, improving">+12%</div>
              <div className="flex items-center gap-1 text-sm text-atlvs-green-500 mt-2" aria-hidden="true">
                <TrendingUp className="w-4 h-4" aria-hidden="true" />
                <span>improving</span>
              </div>
          ...
          <Card variant="atlvs" className="bg-gray-900/50">
            <CardHeader>
              <div className="text-sm text-gray-400 mb-1">Budget Variance</div>
              <div className="text-3xl font-bebas text-atlvs-purple-500" aria-label="Budget variance down 5 percent, under budget">-5%</div>
              <div className="flex items-center gap-1 text-sm text-atlvs-green-500 mt-2" aria-hidden="true">
                <TrendingUp className="w-4 h-4" aria-hidden="true" />
