...
// This component calls: /Users/julianclarkson/Documents/Grasshopper26.10/api/atlvs/budgets/approval
        ...
        >
          <div className="flex items-center justify-center py-12">
            <div className="text-center">
              ...
              <BodyText className="text-grey-400">Loading approval requests...</BodyText>
            </div>
          </div>
        </ContentLayout>
      </AtlvsLayout>
        ...
        >
          <div className="flex items-center justify-center py-12">
            <div className="text-center">
              ...
              <SectionHeader className="mb-2">Failed to Load Approval Requests</SectionHeader>
          ...
          <CardHeader>
            ...
            <div className="space-y-3">
              {requests.map((request) => (
                <div key={request.id} className="flex items-center justify-between p-4 bg-grey-800/50 rounded-lg">
