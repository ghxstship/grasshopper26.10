...
// Import tokens (using require for compiled JS)
const { ghxstshipColors, ghxstshipSemanticColors } = require('../src/design-system/tokens/primitives/ghxstship-colors.ts');
const { ghxstshipTypography, ghxstshipTypographySemantics } = require('../src/design-system/tokens/primitives/ghxstship-typography.ts');
const { spacing } = require('../src/design-system/tokens/primitives/spacing.ts');
const { borders, shadows } = require('../src/design-system/tokens/primitives/borders.ts');
const { animations } = require('../src/design-system/tokens/primitives/animations.ts');
...
`;
  ...
  Object.entries(ghxstshipColors.grey).forEach(([key, value]) => {
    const comment = greyComments[key];
...
try {
  ...
  console.log('   TypeScript tokens → Auto-generated CSS variables');
} catch (error) {
